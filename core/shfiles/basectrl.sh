...
roslaunch realsense2_camera rs_camera.launch tf_prefix:=${RS_TF_PREFIX} ${TF_REMAP_ARGS} & sleep 2;
roslaunch px4ctrl mavros_px4_namespaced.launch & sleep 3;
...
roslaunch vins fast_drone_250.launch ${TF_REMAP_ARGS} & sleep 3;

roslaunch px4ctrl run_ctrl.launch ${TF_REMAP_ARGS} & sleep 1;

roslaunch ego_planner single_run_in_exp.launch ${TF_REMAP_ARGS};
