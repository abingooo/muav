...
namespace ego_planner
{
  ...
  private:
    ...
    ros::Publisher current_yaw_pub_, hover_yaw_cmd_pub_, replan_pub_, new_pub_, bspline_pub_, data_disp_pub_, swarm_trajs_pub_, broadcast_bspline_pub_, waypoint_done_pub_;
