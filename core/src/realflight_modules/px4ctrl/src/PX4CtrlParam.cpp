...
void Parameter_t::config_from_ros_handle(const ros::NodeHandle &nh)
{
	...
	read_essential_param(nh, "auto_takeoff_land/hover_offset_y", takeoff_land.hover_offset_y);
	read_essential_param(nh, "auto_takeoff_land/hover_offset_z", takeoff_land.hover_offset_z);
	read_essential_param(nh, "auto_takeoff_land/hover_offset_yaw", takeoff_land.hover_offset_yaw);

	read_essential_param(nh, "hover_yaw_cmd/enable", hover_yaw_cmd.enable);
	read_essential_param(nh, "hover_yaw_cmd/timeout", hover_yaw_cmd.timeout);
	read_essential_param(nh, "hover_yaw_cmd/max_rate_deg", hover_yaw_cmd.max_rate_deg);
	...
	if (takeoff_land.hover_after_takeoff_mode != 0 && takeoff_land.hover_after_takeoff_mode != 1)
	{
		ROS_ERROR("\"hover_after_takeoff_mode\" must be 0 or 1. Fallback to 0.");
		takeoff_land.hover_after_takeoff_mode = 0;
	}
};
