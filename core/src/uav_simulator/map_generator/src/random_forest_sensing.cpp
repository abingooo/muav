...
int main(int argc, char** argv) {
  ...
  _local_map_pub = n.advertise<sensor_msgs::PointCloud2>(nsTopic("map_generator/local_cloud"), 1);
  _all_map_pub = n.advertise<sensor_msgs::PointCloud2>(nsTopic("map_generator/global_cloud"), 1);
